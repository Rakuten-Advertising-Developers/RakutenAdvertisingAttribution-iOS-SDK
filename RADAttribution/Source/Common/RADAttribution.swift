...
let publicPemString = """
-----BEGIN PUBLIC KEY-----
MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCJF8hUF9hsr4hGU3SR1xXprBt6
2jqesXDjxDRpGZwW2e0OgsltmGMFSIeVLPL1WuO4kHQN2naKyygElzyI5PMe0d1B
NH4iTBfnspKTx64xtk2/cJoW4wBqzOaOHTTog8zLHrUCVYp0f7F8RSofmV1dcBKy
ZojT8eUJBWwk7TrEOQIDAQAB
-----END PUBLIC KEY-----
"""
...
public class RADAttribution {
    ...
    init() {
        ...
        let myClaims = MyClaims(iss: "attribution-sdk",
                                sub: "attribution-sdk",
                                aud: "1",
                                iat: Date(),
